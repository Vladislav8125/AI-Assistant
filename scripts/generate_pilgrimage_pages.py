  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer__logo">
        <img src="{p}/images/log.png" alt="Андреевский" class="footer__logo-img">
      </div>
  ...
  <div class="header-bar">
    <div class="container">
      ...
      <a href="{PREFIX}/" class="header__logo">
        <img src="{PREFIX}/images/log.png" alt="Андреевский — На благо Родины с верой в душе" class="header__logo-img">
      </a>
